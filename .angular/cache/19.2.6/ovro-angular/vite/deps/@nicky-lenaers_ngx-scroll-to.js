...
ScrollToService.ɵfac = function ScrollToService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollToService)(ɵɵinject(DOCUMENT), ɵɵinject(PLATFORM_ID));
};
...
ScrollToDirective.ɵfac = function ScrollToDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollToDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ScrollToService), ɵɵdirectiveInject(Renderer2));
};
